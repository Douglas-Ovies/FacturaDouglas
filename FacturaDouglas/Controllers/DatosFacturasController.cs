...
{
    public class DatosFacturasController : Controller
    {
        ...
        // GET: DatosFacturas/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: DatosFacturas/Create
